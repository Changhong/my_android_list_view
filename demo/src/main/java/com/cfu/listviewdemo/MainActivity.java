...
import com.cfu.listview.RevealListener;
import com.cfu.listview.SwipeLayout;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sample1.addRevealListener(R.id.delete, new RevealListener() {
            @Override
        ...
        sample1.addRevealListener(R.id.starbott, new RevealListener() {
            @Override
            public void onReveal(View child, SwipeLayout.DragEdge edge, float fraction, int distance) {
        ...
        sample3.addRevealListener(R.id.bottom_wrapper_child1, new RevealListener() {
            @Override
            public void onReveal(View child, SwipeLayout.DragEdge edge, float fraction, int distance) {
                View star = child.findViewById(R.id.star);
                float d = child.getHeight() / 2 - star.getHeight() / 2;
